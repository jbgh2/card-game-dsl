...
bet or raise that re-opens the seats behind it is answered by them first and the
seats it re-opened decide last — poker's continuation order), and the showdown as
