...
*Implementation status: §9 steps 1–3 are done. The runtime is now the single
...
info-set leak (§6, §9 step 4) and the front-end derivation (§5) remain open.*
...
escape-hatch mechanics (Schnapsen, Coup, Skat, Cribbage, Stud showdown)
