...
_UNIFORM_LINES: dict[tuple[str, int], list[int]] = {
    ...
    ("cardlang_hearts", 0): [9, 11, 18, 19, 32, 14, 35, 13, 23, 16, 46, 47, 0, 1, 16, 2, 4, 6, 10, 25, 44, 40, 20, 42, 15],
    ("cardlang_hearts", 3): [36, 38, 40, 19, 32, 14, 35, 13, 23, 1, 3, 10, 0, 13, 10, 2, 18, 17, 14, 15, 51, 40, 42, 39, 25, 20, 19],
