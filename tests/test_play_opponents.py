...
_UNIFORM_LINES: dict[tuple[str, int], list[int]] = {
    ...
    ("cardlang_hearts", 3): [
        11, 51, 49, 20, 21, 12, 7, 0, 30, 1, 3, 10, 0, 3, 2, 12, 6, 7, 1, 11, 4, 5, 15,
        9, 10, 32, 8
    ],
    ("cardlang_holdem", 2): [2, 2, 0, 0, 0, 1, 2, 2, 0, 1, 2, 2, 0, 1, 4],
    ("cardlang_kuhn_poker", 0): [0, 1, 2],
    ("cardlang_president", 1): [
        95, 52, 74, 67, 54, 80, 52, 88, 79, 52, 52, 52, 93, 52, 52, 52, 52, 89, 91, 52,
        52, 52, 52, 75, 77, 52, 52, 52, 66, 52, 52
    ],
}
