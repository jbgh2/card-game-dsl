...
PINNED_SCHEMA: frozenset[str] = frozenset(
    {
        'key:active_rules', 'key:again', 'key:agg', 'key:amount',
        'key:applies_when', 'key:args', 'key:arms', 'key:binder', 'key:binders',
        'key:body', 'key:card_points', 'key:cardlang_ir',
        'key:ceiling', 'key:check', 'key:count',
        'key:combos_fn', 'key:cond', 'key:constrains', 'key:content_flavor',
        'key:deck', 'key:decls', 'key:default',
        'key:delta', 'key:demands', 'key:dest', 'key:dest_each',
        ...
        'key:field',
        'key:follows_fn', 'key:func', 'key:functions', 'key:hi',
        'key:if_impossible', 'key:index', 'key:index_expr', 'key:item',
        'key:items', 'key:key', 'key:kind', 'key:leader', 'key:left', 'key:lo',
        'key:loser',
        'key:max_length', 'key:members', 'key:mode', 'key:move_type',
        'key:move_types', 'key:name', 'key:obj', 'key:offering', 'key:op',
        'key:operand', 'key:optional', 'key:otherwise',
