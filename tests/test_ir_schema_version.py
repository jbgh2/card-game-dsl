...
PINNED_SCHEMA: frozenset[str] = frozenset(
    {
        'tag:active_rules', 'tag:after_each', 'tag:all_players',
        'tag:applies_when', 'tag:as', 'tag:assign', 'tag:before_each',
        'tag:binop', 'tag:block', 'tag:call', 'tag:card', 'tag:card_query',
        'tag:choose', 'tag:comprehension', 'tag:continue_to', 'tag:define',
        'tag:demands', 'tag:derived_field', 'tag:direction',
        'tag:domain_query', 'tag:each_simultaneous', 'tag:epistemic_op',
        ...
        'tag:auction_round', 'tag:climb_round', 'tag:quantifier',
        'tag:repeat_until', 'tag:rotate', 'tag:trick_round',
        'tag:rule', 'tag:rule_ref', 'tag:skip_to_next_hand', 'tag:state',
        'tag:state_decl', 'tag:str', 'tag:struct_field', 'tag:struct_lit',
        'tag:subscript', 'tag:mode', 'tag:transition_to', 'tag:turns', 'tag:type_def',
        'tag:type_ref', 'tag:winner', 'tag:zone', 'key:active_rules', 'key:again', 'key:agg',
        'key:always', 'key:amount', 'key:applies_when', 'key:args',
        'key:arms', 'key:binder', 'key:binders', 'key:body',
        'key:cardlang_ir', 'key:cases', 'key:ceiling', 'key:check',
        'key:combos_fn', 'key:cond', 'key:constrains', 'key:content_flavor',
        'key:deck', 'key:decls', 'key:default', 'key:define', 'key:defines',
        'key:demands', 'key:derived', 'key:dest', 'key:dest_each',
        'key:direction', 'key:directions', 'key:distribution', 'key:domain',
        'key:early_termination', 'key:effect', 'key:elements', 'key:elifs',
        'key:else', 'key:event', 'key:expr', 'key:field', 'key:fields',
        'key:follows_fn', 'key:form', 'key:func', 'key:functions',
        ...
        'key:outcome_fn', 'key:params', 'key:participants', 'key:winner_fn',
         'key:payload_types', 'key:payloads',
        'key:phases', 'key:play_zone', 'key:player', 'key:players',
        'key:positions', 'key:pred', 'key:qualifier', 'key:quant',
        'key:query', 'key:rank', 'key:rank_dir', 'key:ranking',
        'key:ranking_convention', 'key:ref', 'key:refs', 'key:right',
        'key:role', 'key:rules', 'key:selection', 'key:source',
        'key:source_zone', 'key:state', 'key:suit', 'key:tag', 'key:target', 'key:transitions', 'key:teams',
        'key:termination', 'key:then', 'key:trump', 'key:type',
        'key:type_name', 'key:types', 'key:value', 'key:values', 'key:var',
        'key:verb', 'key:visibility', 'key:where', 'key:winner', 'key:zones'
    }
)
