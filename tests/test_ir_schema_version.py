...
PINNED_SCHEMA: frozenset[str] = frozenset(
    {
        ...
        'tag:quantifier', 'tag:repeat_until', 'tag:rotate', 'tag:round',
        'tag:rule', 'tag:rule_ref', 'tag:skip_to_next_hand', 'tag:state',
        'tag:state_decl', 'tag:str', 'tag:struct_field', 'tag:struct_lit',
        'tag:subscript', 'tag:transition_to', 'tag:turns', 'tag:type_def',
        'tag:type_ref', 'tag:winner', 'tag:zone', 'key:again', 'key:agg',
        ...
        'key:guard', 'key:hi', 'key:high', 'key:if_impossible', 'key:index',
        ...
        'key:names', 'key:obj', 'key:op', 'key:operand', 'key:optional',
        'key:order_mode', 'key:otherwise', 'key:outcome_cases',
        'key:outcome_fn', 'key:params', 'key:participants',
        'key:partnerships', 'key:payload_types', 'key:payloads',
        ...
        'key:source_zone', 'key:state', 'key:suit', 'key:tag', 'key:target',
