...
TREATMENT: dict[tuple[str, str], tuple[str, str]] = {
    ...
    ("SubsetQuery", "where"): (TOTAL, "Boolean"),
    ...
    ("SubsetQuery", "source"): (GRADUAL, "Collection<Card>"),
    ...
    ("SubsetQuery", "body"): (CONTEXTUAL, "the aggregation"),
    ("SubsetQuery", "default"): (CONTEXTUAL, "the aggregation"),
